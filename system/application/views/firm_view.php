...
echo "<tr><td>".anchor_form("billing/docs_register/{$r->id}","Регистрация документов")."</td>";
echo "<td>".anchor_form("billing/pre_schet_na_oplatu/{$r->id}","Счет на оплату (СФ)")."</td></tr>";
