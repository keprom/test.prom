...
$("#pause_load div").click(function(){
	...
	// // Выполняем если по кнопке кликнули
		function load_data()
		{
			...
			$.ajax({
				url: "http://admpc/index.php/billing/svod_kvt_po_godam_ajax", // Обработчик
...
<table width=100%>
	<tr><td align=center><b>Электропотребление по точкам учета за все периоды</b></td></tr>
</table>
...
<table border = 1 width = 100% id="content">
  <tr>
    <th colspan="5"><center><b>ФИРМА</b></center></th>
  ...
  <tr>
    ...
    <td rowspan="2"><center><b>Наименование ТП</b></center></td>
    <td rowspan="2"><center><b>Наименование ТУ</b></center></td>
	<?php
