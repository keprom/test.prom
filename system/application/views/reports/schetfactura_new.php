...
<FONT size=7>
    ...
    <b>
        <table>
            ...
            <?php if ($do_fine): ?>
                <tr>
                    <td>Сальдо пени на начало месяца <?php echo $fine_saldo; ?>; начислено
                        пени <?php echo $fine_value; ?>;оплачено пени <?php echo $fine_oplata; ?>; сальдо пени на конец
                        месяца <?php echo $fine_saldo + $fine_value - $fine_oplata; ?>.
                    </td>
                </tr>
                <tr>
                    <td>Сальдо на начало месяца <?php echo sprintf("%22.2f", $saldo); ?>; сальдо на конец
                        месяца <?php echo sprintf("%22.2f", $saldo - $oplata + $itog->itogo_with_nds); ?>.
                    </td>
                </tr>
            <?php endif; ?>
            </tbody>
