...
{
	if ($var==0) return "&nbsp;"; else
	return sprintf("%22.".$nums."f",round($var*1000)/1000);
}
?>
<html>
<head>
 ...
 <TR>
  ...
  <TR>
	...
	<TR>
		...
		$sum_bez_nds+=f_d($tariff_kvt[$j]*$tariff_value[$j]);	
		?> </FONT> 
...
<?php endfor;?>
  <TR>
    ...
    <TD align=right><FONT size=2><B>&nbsp;<?php echo f_d($sum_bez_nds + $sum_nds);?></B></FONT> 
    <TD align=right bgColor=#c0c0c0><FONT size=2>&nbsp;</FONT> 
    <TD align=right><FONT size=2><B>&nbsp;</B></FONT> </TD>
 
 </table>
 <center>
 <?php echo num2str(f_d($sum_bez_nds + $sum_nds));?>
 </center>
	<br>
	<table width=100%  >
	<tr>
	...
	<tr>
	<td align=left><?php echo "Ламнова Л.П."; ?>____________</td><td align=right>Техник ____________________________</td>
	</tr>
	<tr>
	...
	<tr>
	<td align=left><?php echo "Ламнова Л.П."; ?>_______________</td><td align=right>___________________</td>
	</tr>
	<tr>
	<td align=left>(Ф.И.О., подпись)</td><td align=right>(Ф.И.О., подпись)</td>
	</tr>
