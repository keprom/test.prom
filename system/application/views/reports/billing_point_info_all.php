...
<tr>
<td><?php echo $j++;?></td>
<td><?php echo $i->firm_dogovor;?></td>
<td><?php echo $i->firm_name;?></td>
<td><?php echo $i->billing_point_name;?></td>
<td><?php echo $i->billing_point_address;?></td>
<td><?php echo $i->counter_type_name;?></td>
<td>&nbsp;<?php echo $i->gos_nomer;?></td>
<td>&nbsp;<?php echo $i->transform;?></td>
<td>&nbsp;<?php echo $i->power;?></td>
<td>&nbsp;<?php echo $i->time_in_day;?></td>
<td>&nbsp;<?php echo $i->not_worked_day;?></td>
<td>&nbsp;<?php echo $i->amper;?></td>
</tr>
<?php endforeach;?>
</table>
</body>
